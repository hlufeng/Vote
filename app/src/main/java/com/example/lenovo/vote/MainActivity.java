...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv1 = findViewById(R.id.btn1);
        TextView tv2 = findViewById(R.id.btn2);
        TextView tv3 = findViewById(R.id.btn3);
...
//        tv1.setOnClickListener();
    ...
    private String doVote(String voteStr) {
        ...
        try {
            ...
            String urlPath = "http://10.63.217.164:8080/vote/GetVote";
